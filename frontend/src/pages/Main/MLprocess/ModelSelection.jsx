...
import { ChevronLeft, BrainCircuit, Target, SlidersHorizontal, Settings } from "lucide-react";
import api from "../../../api";
...
export default function ModelSelection({ category, type, onPrevStep, onNextStep }) {
  ...
  const renderSelectedModel = () => {
    ...
    if (!targetColumn) return <p className="text-slate-500 mt-4">Please select a target variable first.</p>;
      ...
      <div className="p-8 space-y-8">
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm relative">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h3 className="text-lg font-bold text-slate-800">2. Select Algorithm</h3>
          </div>
